...
import { type ApiError, toApiError, type UnknownObject } from "@papaya-fleet/utils";
...
export function AddDriverForm({ onSuccess, onCancel }: AddDriverFormProps) {
  ...
  const form = useForm<CreateDriverInput>({
    resolver: zodResolver(createDriverSchema) as unknown as Parameters<typeof useForm<CreateDriverInput>>[0]['resolver'],
  ...
  } as UnknownObject as Parameters<typeof useMutation>[0]);
